var data_url = 'https://dl.dropbox.com/s/u5aqbie6f2ea5hl/data.csv?dl=1';
...
d3.csv(data_url, function (data) {
    ...
    var xVars = [{
        ...
        "variable": "Philanthropic Impact Score"
    }, {
        "variable": "Statuses"
    }];
    ...
    var circles = svg.selectAll('circle')
        ...
        .on("mouseover", function (d) {
            tooltip.transition()
                ...
                .style("opacity", 1.0)
                .style("border", "red");
            tooltip.html("<img src=" + d["Profile"] + " width=40% height=90px align=middle" + " >" + "<p><strong> " + d["Screen Name"] + " </strong> </p>" + "<p><strong>Bio:  </strong>" + d["Description"] + "</p>" + "<p><strong>Tags Mentioned:  </strong>" + d["Tags Mentioned"] + "</p>" + "<p><strong>Users mentioned:  </strong>" + d["Users Mentioned"] + "</p>" + "<br>" + "<p><strong>Potentially:  </strong>" + d.prediction + "</p>" + "<p><strong>Friends:  </strong>" + formatNumber(d["Friends"]) + "</p>" + "<p><strong>Statuses: </strong>" + formatNumber(d["Statuses"]) + "</p>" + "<p><strong>Followers:  </strong>" + formatNumber(d['Followers']) + "</p>" + "<p><strong>Twitter Impact Score:  </strong>" + formatNumber(d["Twitter Score"]) + "</p>" + "<p><strong>Philanthropic Impact Score:  </strong>" + formatNumber(d["Philanthropic Impact Score"]) + "</p>")
